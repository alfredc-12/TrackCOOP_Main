  ...
  return (
    <section className="h-full bg-[#FFFAF2] p-5 text-[#123D2A] sm:p-6">
      <div className="flex h-full flex-col">
        ...
        <article className="relative mt-5 flex min-h-[430px] flex-1 overflow-hidden rounded-[16px] border border-[#CFE0C8] bg-[#123D2A] shadow-[0_28px_80px_rgba(31,107,67,0.42)]">
