  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <form
        ...
        className="border border-[#DDE8D8] bg-white p-6 shadow-sm sm:p-8"
      >
        ...
        {error ? (
          <div className="mt-5 flex gap-3 border border-red-200 bg-red-50 p-4 text-sm text-red-800">
        ...
        <Button
          ...
          className="mt-6 h-11 w-full bg-[#123D2A] text-white hover:bg-[#1F6B43]"
        >
      ...
      <section className="border border-[#DDE8D8] bg-[#F8F1E5] p-6 shadow-sm sm:p-8">
        {status ? (
          <div>
                ...
                <ul className="mt-3 grid gap-2 text-sm text-[#365F4A]">
                  {status.missingOrRejectedRequirements.map((requirement) => (
                    <li
                      ...
                      className="flex items-center justify-between gap-3 border border-[#DDE8D8] bg-white px-3 py-2"
                    >
          ...
          <div className="grid min-h-[320px] place-items-center text-center">
            <div>
              <div className="mx-auto grid size-12 place-items-center bg-[#EAF3E8] text-[#1F6B43]">
