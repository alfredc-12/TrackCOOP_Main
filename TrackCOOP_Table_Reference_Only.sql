...
-- Stores complete public, chairman-entered, or imported membership applications.
-- The application remains separate from accepted member profiles until approval.
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- TABLE: membership_application_beneficiaries
-- Stores child and beneficiary rows attached to a membership application.
-- --------------------------------------------------------------------------
...
-- Stores protected application attachments and file metadata.
-- Files are stored outside public web paths.
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- TABLE: membership_application_status_history
-- Records every membership-application status transition.
-- --------------------------------------------------------------------------
...
-- Stores hashed account-activation tokens for approved member portal accounts.
-- --------------------------------------------------------------------------
...
-- --------------------------------------------------------------------------
-- TABLE: membership_application_requirements
-- Tracks orientation, fee, share-capital, signed-form, and document requirements.
-- Placed after payment_references to keep clean-schema foreign-key imports safe.
-- --------------------------------------------------------------------------
